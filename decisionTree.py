...
# Paths (unchanged)
tb_path = r"D:\Btech IT\Sem VII\TB-Detect\TB_Chest_Radiography_Database\Tuberculosis"
normal_path = r"D:\Btech IT\Sem VII\TB-Detect\TB_Chest_Radiography_Database\Normal"

# Function to load dataset (UNCHANGED)
def load_dataset(normal_count, tb_count=700, img_size=(128, 128)):
    from tensorflow.keras.preprocessing.image import load_img, img_to_array  # import here so rest of script doesn't require TF
